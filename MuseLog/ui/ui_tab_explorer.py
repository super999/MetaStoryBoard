...
class Ui_TabExplorer(object):
    def setupUi(self, TabExplorer):
        ...
        self.midPanel = QSplitter(TabExplorer)
        self.midPanel.setObjectName(u"midPanel")
        self.midPanel.setOrientation(Qt.Horizontal)
        self.treeView = QTreeView(self.midPanel)
        self.treeView.setObjectName(u"treeView")
        self.midPanel.addWidget(self.treeView)
        self.rightPanel = QWidget(self.midPanel)
        ...
        self.btnPS = QPushButton(self.buttonWidget)
        self.btnPS.setObjectName(u"btnPS")

        self.horizontalLayout.addWidget(self.btnPS)

        self.btnPsOuput = QPushButton(self.buttonWidget)
        self.btnPsOuput.setObjectName(u"btnPsOuput")

        self.horizontalLayout.addWidget(self.btnPsOuput)
        ...
        self.midPanel.addWidget(self.rightPanel)

        self.verticalLayout.addWidget(self.midPanel)

        self.bottomPanel = QWidget(TabExplorer)
        self.bottomPanel.setObjectName(u"bottomPanel")
        self.bottomPanel.setMaximumSize(QSize(16777215, 50))
        self.horizontalLayout_2 = QHBoxLayout(self.bottomPanel)
        ...
        self.labelSelectPath = QLabel(self.bottomPanel)
        self.labelSelectPath.setObjectName(u"labelSelectPath")

        self.horizontalLayout_2.addWidget(self.labelSelectPath)
    ...
    def retranslateUi(self, TabExplorer):
        ...
        self.btnPS.setText(QCoreApplication.translate("TabExplorer", u"PS", None))
        self.btnPsOuput.setText(QCoreApplication.translate("TabExplorer", u"PS\u5bfc\u51fa", None))
        ...
        self.label.setText(QCoreApplication.translate("TabExplorer", u"\u5f53\u524d\u8def\u5f84", None))
        self.labelSelectPath.setText(QCoreApplication.translate("TabExplorer", u"C:\\aaaa\\bbbbb\\cccc", None))
    # retranslateUi
